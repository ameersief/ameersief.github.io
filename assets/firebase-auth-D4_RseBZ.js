import{L as qn,s as Kt,t as Gn,u as zn,o as Tt,C as wt,r as yt,v as Kn,q as he,w as Xe,_ as I,g as h,x as $n,a as $t,j as v,F as Qe,y as Bn,z as J,i as Ze,c as Bt,A as jn,b as Yn,e as Be,p as Jn,B as Xn,D as Qn,G as te,H as ne,J as Zn}from"./firebase-core-kffZKNeW.js";import"./vendor-CVXdPjN3.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pe=new qn("@firebase/auth");function ni(n,...e){Pe.logLevel<=$t.WARN&&Pe.warn(`Auth (${he}): ${n}`,...e)}function we(n,...e){Pe.logLevel<=$t.ERROR&&Pe.error(`Auth (${he}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(nt()||Kn()||"connection"in navigator)?navigator.onLine:!0}function ri(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fe{constructor(e,t){this.shortDelay=e,this.longDelay=t,C(t>e,"Short delay should be less than long delay!"),this.isMobile=Gn()||zn()}get(){return ii()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bi(n,e){return D(n,"POST","/v1/accounts:signInWithPassword",p(n,e))}async function be(n,e){return m(n,"POST","/v1/accounts:sendOobCode",p(n,e))}async function ji(n,e){return be(n,e)}async function Yi(n,e){return be(n,e)}async function Ji(n,e){return be(n,e)}async function Xi(n,e){return be(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qi(n,e){return D(n,"POST","/v1/accounts:signInWithEmailLink",p(n,e))}async function Zi(n,e){return D(n,"POST","/v1/accounts:signInWithEmailLink",p(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bt(n,e){return m(n,"POST","/v1/accounts:sendVerificationCode",p(n,e))}async function tr(n,e){return D(n,"POST","/v1/accounts:signInWithPhoneNumber",p(n,e))}async function nr(n,e){const t=await D(n,"POST","/v1/accounts:signInWithPhoneNumber",p(n,e));if(t.temporaryProof)throw ie(n,"account-exists-with-different-credential",t);return t}const ir={USER_NOT_FOUND:"user-not-found"};async function rr(n,e){const t={...e,operation:"REAUTH"};return D(n,"POST","/v1/accounts:signInWithPhoneNumber",p(n,t),ir)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function or(n){const e=te(ne(n)).link,t=e?te(ne(e)).deep_link_id:null,i=te(ne(n)).deep_link_id;return(i?te(ne(i)).link:null)||i||t||e||n}class ge{constructor(e){const t=te(ne(e)),i=t.apiKey??null,r=t.oobCode??null,s=sr(t.mode??null);u(i&&r&&s,"argument-error"),this.apiKey=i,this.operation=s,this.code=r,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=or(e);try{return new ge(t)}catch{return null}}}function io(n){return ge.parseLink(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function so(n,e){const t=h(n);await De(!0,t,e);const{providerUserInfo:i}=await hi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=Tn(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function ot(n,e,t=!1){const i=await O(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function De(n,e,t){await ce(e);const i=Tn(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";u(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dr(n,e){return D(n,"POST","/v1/accounts:signInWithCustomToken",p(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oo(n,e){if(I(n.app))return Promise.reject(T(n));const t=_(n),i=await dr(t,{token:e,returnSecureToken:!0}),r=await A._fromIdTokenResponse(t,"signIn",i);return await t._updateCurrentUser(r.user),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function po(n,e,t){const i=_(n),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){u(a.handleCodeInApp,i,"argument-error"),a&&Le(i,o,a)}s(r,t),await H(i,r,"getOobCode",Ji,"EMAIL_PASSWORD_PROVIDER")}function mo(n,e){const t=ge.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function go(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=h(n),r=G.credentialWithLink(e,t||ae());return u(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),at(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Io(n,e){const t=nt()?ae():"http://localhost",i={identifier:e,continueUri:t},{signinMethods:r}=await fr(h(n),i);return r||[]}async function _o(n,e){const t=h(n),r={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&Le(t.auth,r,e);const{email:s}=await ji(t.auth,r);s!==n.email&&await n.reload()}async function Eo(n,e,t){const i=h(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&Le(i.auth,s,t);const{email:o}=await Xi(i.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(n){var r,s;if(!n)return null;const{providerId:e}=n,t=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},i=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&(n!=null&&n.idToken)){const o=(s=(r=Oe(n.idToken))==null?void 0:r.firebase)==null?void 0:s.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new j(i,a)}}if(!e)return null;switch(e){case"facebook.com":return new gr(i,t);case"github.com":return new Ir(i,t);case"google.com":return new _r(i,t);case"twitter.com":return new Er(i,t,n.screenName||null);case"custom":case"anonymous":return new j(i,null);default:return new j(i,e,t)}}class j{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class An extends j{constructor(e,t,i,r){super(e,t,i),this.username=r}}class gr extends j{constructor(e,t){super(e,"facebook.com",t)}}class Ir extends An{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class _r extends j{constructor(e,t){super(e,"google.com",t)}}class Er extends An{constructor(e,t,i){super(e,"twitter.com",t,i)}}function vo(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:mr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ao(n,e){return h(n).setPersistence(e)}function Ro(n){return mn(n)}async function Po(n,e){return _(n).validatePassword(e)}function Tr(n,e,t,i){return h(n).onIdTokenChanged(e,t,i)}function wr(n,e,t){return h(n).beforeAuthStateChanged(e,t)}function So(n,e,t,i){return h(n).onAuthStateChanged(e,t,i)}function ko(n){h(n).useDeviceLanguage()}function No(n,e){return h(n).updateCurrentUser(e)}function Co(n){return h(n).signOut()}function Oo(n,e){return _(n).revokeAccessToken(e)}async function bo(n){return h(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ft(){return typeof E().WorkerGlobalScope<"u"&&typeof E().importScripts=="function"}async function Dr(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Lr(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function Mr(){return ft()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{constructor(e,t,i,r,s=!1){this.auth=e,this.resolver=i,this.user=r,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:r,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:i,tenantId:s||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Jr;case"linkViaPopup":case"linkViaRedirect":return Qr;case"reauthViaPopup":case"reauthViaRedirect":return Xr;default:y(this.auth,"internal-error")}}resolve(e){C(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){C(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es="pendingRedirect",Ae=new Map;class ts extends Dn{constructor(e,t,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,i),this.eventId=null}async execute(){let e=Ae.get(this.auth._key());if(!e){try{const i=await ns(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(t){e=()=>Promise.reject(t)}Ae.set(this.auth._key(),e)}return this.bypassAuthState||Ae.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function ns(n,e){const t=Mn(e),i=Ln(n);if(!await i._isAvailable())return!1;const r=await i._get(t)==="true";return await i._remove(t),r}async function gt(n,e){return Ln(n)._set(Mn(e),"true")}function is(n,e){Ae.set(n._key(),e)}function Ln(n){return S(n._redirectPersistence)}function Mn(n){return ye(es,n.config.apiKey,n.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zo(n,e,t){return rs(n,e,t)}async function rs(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=_(n);X(n,e,L),await i._initializationPromise;const r=z(i,t);return await gt(r,i),r._openRedirect(i,e,"signInViaRedirect")}function Ko(n,e,t){return ss(n,e,t)}async function ss(n,e,t){const i=h(n);if(X(i.auth,e,L),I(i.auth.app))return Promise.reject(T(i.auth));await i.auth._initializationPromise;const r=z(i.auth,t);await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function $o(n,e,t){return os(n,e,t)}async function os(n,e,t){const i=h(n);X(i.auth,e,L),await i.auth._initializationPromise;const r=z(i.auth,t);await De(!1,i,e.providerId),await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function Bo(n,e){return await _(n)._initializationPromise,Un(n,e,!1)}async function Un(n,e,t=!1){if(I(n.app))return Promise.reject(T(n));const i=_(n),r=z(i,e),o=await new ts(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Vn(n){const e=Ue(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bs="__/auth/handler",Ds="emulator/auth/handler",Ls=encodeURIComponent("fac");async function Wt(n,e,t,i,r,s){u(n.config.authDomain,n,"auth-domain-config-required"),u(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:he,eventId:r};if(e instanceof L){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Qn(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,f]of Object.entries({}))o[d]=f}if(e instanceof Q){const d=e.getScopes().filter(f=>f!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const c=await n._getAppCheckToken(),l=c?`#${Ls}=${encodeURIComponent(c)}`:"";return`${Ms(n)}?${J(a).slice(1)}${l}`}function Ms({config:n}){return n.emulator?it(n,Ds):`https://${n.authDomain}/${bs}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gs=300,zs=Kt("authIdTokenMaxAge")||Gs;let zt=null;const Ks=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>zs)return;const r=t==null?void 0:t.token;zt!==r&&(zt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function jo(n=Yn()){const e=Bt(n,"auth");if(e.isInitialized())return e.getImmediate();const t=xi(n,{popupRedirectResolver:Vs,persistence:[Wr,kr,Nn]}),i=Kt("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(i,location.origin);if(location.origin===s.origin){const o=Ks(s.toString());wr(t,o,()=>o(t.currentUser)),Tr(t,a=>o(a))}}const r=jn("auth");return r&&Wi(t,`http://${r}`),t}function $s(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}Si({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=r=>{const s=w("internal-error");s.customData=r,t(s)},i.type="text/javascript",i.charset="UTF-8",$s().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});qs("Browser");export{Zs as ActionCodeOperation,ge as ActionCodeURL,me as AuthCredential,to as AuthErrorCodes,ue as EmailAuthCredential,G as EmailAuthProvider,U as FacebookAuthProvider,Ys as FactorId,F as GithubAuthProvider,V as GoogleAuthProvider,b as OAuthCredential,ve as OAuthProvider,Qs as OperationType,q as PhoneAuthCredential,Y as PhoneAuthProvider,Fs as PhoneMultiFactorGenerator,Js as ProviderId,Uo as RecaptchaVerifier,Ye as SAMLAuthProvider,Xs as SignInMethod,xs as TotpMultiFactorGenerator,_t as TotpSecret,x as TwitterAuthProvider,uo as applyActionCode,wr as beforeAuthStateChanged,Mo as browserCookiePersistence,kr as browserLocalPersistence,Vs as browserPopupRedirectResolver,Nn as browserSessionPersistence,hr as checkActionCode,co as confirmPasswordReset,Wi as connectAuthEmulator,ho as createUserWithEmailAndPassword,eo as debugErrorMap,bo as deleteUser,Io as fetchSignInMethodsForEmail,vo as getAdditionalUserInfo,jo as getAuth,no as getIdToken,fi as getIdTokenResult,Do as getMultiFactorResolver,Bo as getRedirectResult,kt as inMemoryPersistence,Wr as indexedDBLocalPersistence,xi as initializeAuth,Ro as initializeRecaptchaConfig,mo as isSignInWithEmailLink,ur as linkWithCredential,Fo as linkWithPhoneNumber,Go as linkWithPopup,$o as linkWithRedirect,Lo as multiFactor,So as onAuthStateChanged,Tr as onIdTokenChanged,io as parseActionCodeURL,ti as prodErrorMap,lr as reauthenticateWithCredential,xo as reauthenticateWithPhoneNumber,qo as reauthenticateWithPopup,Ko as reauthenticateWithRedirect,gi as reload,Oo as revokeAccessToken,_o as sendEmailVerification,ao as sendPasswordResetEmail,po as sendSignInLinkToEmail,Ao as setPersistence,ro as signInAnonymously,at as signInWithCredential,oo as signInWithCustomToken,fo as signInWithEmailAndPassword,go as signInWithEmailLink,Vo as signInWithPhoneNumber,Wo as signInWithPopup,zo as signInWithRedirect,Co as signOut,so as unlink,No as updateCurrentUser,wo as updateEmail,yo as updatePassword,Ho as updatePhoneNumber,To as updateProfile,ko as useDeviceLanguage,Po as validatePassword,Eo as verifyBeforeUpdateEmail,lo as verifyPasswordResetCode};
